...
class TitleScreen:
    def __init__(self, root, on_start_g):
        ...
        start_button = Button(self.title_frame, text="Start Game", font=("Times New Roman", 18), command=self.start_bet)
        start_button.pack()
...
class BetScreen:
    ...
    def setup_game(self):
        ...
        self.root.title('BlackJack - bet')
        self.root.eval('tk::PlaceWindow . center')



        self.title_frame = Frame(self.root, bg="green")
        self.title_frame.pack(expand=True, fill=BOTH)

        title_label = Label(self.title_frame, text="Bet", font=("Times New Roman", 36, "bold"), bg="dark green", fg="white")
        title_label.pack(pady=20)
...
class BlackjackGame:
    def __init__(self, root):
        self.root = root
        self.title_screen = BetScreen(root, self.setup_game)
